...
<picture>
  ...
  <img src="banner.svg?v=1" alt="Abhishek Rai A — AI & ML Student" width="100%">
</picture>
...
- 🛡️ **Row-Level Security everywhere** — public reads go through sanitized Postgres views, admin roles are checked via security-definer RPCs, author identity never leaks
...
- 🎯 **Visualizer** — Bubble, Selection, Insertion, Merge & Quick Sort with live pointer flags, sound mode, confetti on completion, step-by-step export
- ⚡ **Race mode** — all 5 algorithms on the same input, side by side, with a leaderboard and race history
